          ...
          <div class="w-[60%] sm:w-full text-center space-y-10">
            <!-- Hero Title -->
             <div class="space-y-4">
              ...
              >
              <div class="relative">
                <div class="text-5xl lg:text-2xl font-medium lg:font-semibold leading-tight tracking-wide capitalize mb-3 text-gray-800">
            ...
            >
              <div class="flex flex-col items-center sm:flex-row gap-4 justify-center">
                <a href="#menu" class="px-8 py-3 md:px-4 md:py-2 bg-emerald-600 text-white font-medium text-lg md:text-base md:font-normal tracking-wider rounded-lg hover:bg-emerald-700  transition-colors duration-300 shadow-lg hover:shadow-xl">
                  Mulai Sekarang
                </a>
              </div>
            </TransitionChild>
            ...
            <div class="space-y-10 mt-6">
              <TransitionChild
              as="template"
              enter="transform transition duration-1000 delay-700"
              enter-from="opacity-0 translate-y-4"
              enter-to="opacity-100 translate-y-0"
              leave="transform duration-300 transition ease-in-out"
              leave-from="opacity-100 translate-y-0"
            ...
            enter="transform transition duration-1000 delay-1200"
            enter-from="opacity-0 translate-y-4"
            enter-to="opacity-100 translate-y-0"
            leave="transform duration-300 transition ease-in-out"
            leave-from="opacity-100 translate-y-0"
            leave-to="opacity-0 translate-y-4">
              <section id="menu" class="grid grid-cols-4 md:grid-cols-2 gap-4 mt-6">
                <template v-for="card in cards" :key="card.name">
                  <router-link :to="card.link" class="p-9 flex flex-col gap-3 items-center justify-center rounded-md bg-green-500">
                    <img src="/maghrib.png" class="w-16 h-1w-16 object-cover" alt="">
